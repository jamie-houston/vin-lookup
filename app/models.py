...
class Car(db.Model):
    ...
    def __init__(self, vin, ext_color, int_color, car_model, opt_code, sold_to, ship_to, model_year):
        self.vin = vin
...
class ScraperLog(db.Model):
    ...
    def __init__(self, found_cars, run_start, run_type, success):
...
class CarSchema(ma.Schema):
    class Meta:
        # Fields to expose
        fields = ('id', 'vin', 'ext_color', 'int_color', 'car_model', 'opt_code', 'sold_to', 'ship_tp', 'created_date', 'serial_number', 'model_year')
